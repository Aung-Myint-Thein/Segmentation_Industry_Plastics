...
1. Mature customers
2. Entry level customers
3. Support oriented and cash rich customers

Using the table above, we can describe the specific and differentiated needs of segments as following :

1. **Mature customers**

These customers are mature businesses. They needs their supplier to have an efficient and reliable ordering process (`r round(cluster_profile_ratios["MAXDIFF: Efficient and reliable ordering process",1]-1,2)`% higher than population average), delivery & inventory management (`r round(cluster_profile_ratios["MAXDIFF: Delivery &amp; inventory management",1]-1,2)`% higher than population average), and formula based or fixed material price (`r round(cluster_profile_ratios["MAXDIFF: Formula based or fixed material price",1]-1,2)`% higher than population average). This shows that they are more mature and process based clients and they want certainty and predictability in their cost. This is strengthened more by having `r round(cluster_profile_ratios["MAXDIFF: Credit limit. financing and payment terms",1]-1,2)` percent higher than population average in needs of credit limit, financing and payment terms and the highest among 3 segments.
